...
🎉 El panel de control se abre en `http://localhost:21298`
...
- Panel de control: `http://localhost:21298/dashboard`
- API compatible con OpenAI: `http://localhost:21298/v1`
...
| `PORT`                                               | por defecto del framework                  | Puerto del servicio (`21298` en los ejemplos)                                        |
...
| `BASE_URL`                                           | `http://localhost:21298`                   | URL base interna del lado del servidor usada por los trabajos de sincronización en la nube |
...
- Establece `PORT=21298` y `NEXT_PUBLIC_BASE_URL=http://localhost:21298`
