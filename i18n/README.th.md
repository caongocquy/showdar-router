...
<div align="center">
  <img src="../images/9router.png?1" alt="แดชบอร์ด Showdar Router" width="800"/>
...
**Showdar Router แก้ปัญหาเหล่านี้:**
...
🎉 เปิดแดชบอร์ดที่ `http://localhost:21298`
...
URL ค่าเริ่มต้น:
- แดชบอร์ด: `http://localhost:21298/dashboard`
- OpenAI-compatible API: `http://localhost:21298/v1`

---

## 🛠️ เครื่องมือ CLI ที่รองรับ

Showdar Router ทำงานได้อย่างราบรื่นกับเครื่องมือเขียนโค้ด AI ทุกประเภท:
...
Headroom เป็นตัวเลือกและทำงานแยกกัน Showdar Router เรียก endpoint `/v1/compress` ของ Headroom จากนั้นยังคงเลือกเส้นทาง, fallback, auth และติดตามการใช้งานตามปกติ:
...
ถ้า Headroom ดับหรือคืน error, Showdar Router จะ fail open และส่งคำขอต้นฉบับ
...
- เครื่องมือ CLI ของคุณส่งรูปแบบ OpenAI → Showdar Router แปลง → ผู้ให้บริการได้รับรูปแบบต้นฉบับ
...
<details>
<summary><b>💳 Showdar Router เก็บเงินฉันหรือไม่?</b></summary>

**ไม่.** Showdar Router เป็นซอฟต์แวร์ฟรีแบบ open source ที่ทำงานบนเครื่องของคุณเอง มันไม่มีวันเรียกเก็บเงินจากคุณ

**คุณจ่ายเงินเฉพาะ:**
- ✅ **ผู้ให้บริการสมาชิก** (Claude Code $20/เดือน, Codex $20-200/เดือน) → จ่ายตรงให้พวกเขาบนเว็บไซต์ของพวกเขา
- ✅ **ผู้ให้บริการราคาถูก** (GLM, MiniMax) → จ่ายตรงให้พวกเขา, Showdar Router แค่เลือกเส้นทางคำขอของคุณ
- ❌ **ตัว Showdar Router เอง** → **ไม่มีวันเรียกเก็บเงินใดๆ ทั้งสิ้น**

Showdar Router เป็น proxy/router ท้องถิ่น มันไม่มีบัตรเครดิตของคุณ, ไม่สามารถส่งใบแจ้งหนี้ได้ และไม่มีระบบชำระเงิน เป็นซอฟต์แวร์ฟรีทั้งหมด
...
Showdar Router แค่เลือกเส้นทางคำขอของคุณไปหาพวกเขา — ไม่มี "กับดัก" หรือการเรียกเก็บเงินในอนาคต เป็นบริการที่ฟรีจริงๆ และ Showdar Router ทำให้ใช้งานง่ายด้วยการรองรับ fallback
...
3. **ใช้ผู้ให้บริการสมาชิก** ก็ต่อเมื่อมีอยู่แล้ว:
   - Showdar Router ช่วยเพิ่มประสิทธิภาพมูลค่าของพวกเขาผ่านการติดตามโควตา
...
**OAuth Token หมดอายุ**
- รีเฟรชอัตโนมัติโดย Showdar Router
...
- ตั้ง `PORT=21298` และ `NEXT_PUBLIC_BASE_URL=http://localhost:21298`
...
- **เว็บไซต์**: [showdar-router.com](https://9router.com)
...
ขอขอบคุณผู้มีส่วนร่วมทุกคนที่ช่วยทำให้ Showdar Router ดียิ่งขึ้น!
