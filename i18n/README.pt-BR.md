...
🎉 O painel abre em `http://localhost:20129`
...
- Painel: `http://localhost:20129/dashboard`
- API compatível com OpenAI: `http://localhost:20129/v1`
...
| `PORT` | padrão da estrutura | Porta de serviço (`20129` nos exemplos) |
...
| `BASE_URL` | `http://localhost:20129` | URL base interna do lado do servidor usada por trabalhos de sincronização na nuvem |
...
- Definir `PORT=20129` e `NEXT_PUBLIC_BASE_URL=http://localhost:20129`
