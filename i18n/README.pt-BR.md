<div align="center">
  <img src="../images/9router.png?1" alt="Painel do Showdar Router" width="800"/>
  
  # Showdar Router — roteador de IA GRATUITO e economizador de tokens
...
└──────┬──────┘
       ...
       ↓
┌─────────────────────────────────────────────┐
│           Showdar Router (Roteador inteligente)            │
...
🎉 O painel abre em `http://localhost:21298`
...
- Painel: `http://localhost:21298/dashboard`
- API compatível com OpenAI: `http://localhost:21298/v1`
...
<table>
  <tr>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw no Showdar Router<br/>por <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>Showdar Router + Claude Code Configuração ilimitada GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
      ...
      <b>🇺🇸 Inglês</b><br/>
      <sub>Showdar Router + Claude Code Configuração GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
...
<img src="https://img.youtube.com/vi/Ttpc26m39Dw/maxresdefault.jpg" alt="Claude CLI Free Setup" width="300"/>
      ...
      <b>🇺🇸 Inglês</b><br/>
      Configuração gratuita <sub>Claude CLI com Showdar Router 🚀<br/>por <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + Showdar Router<br/>por <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
<td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
<sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Configuração Rápida Showdar Router 🚀<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
      <sub>Cara Implante Showdar Router no Hugging Face GRATUITAMENTE sem parar! | Alternativa VPS RAM 16GB<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=GyX-DLvePW8">
    ...
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + Showdar Router: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>por <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
</td>
...
> 🎬 **Fez um vídeo sobre o Showdar Router?** Envie um [Pull Request](https://github.com/decolua/9router/pulls) adicionando seu vídeo a esta seção - nós o mesclaremos!

---

## 🛠️ Ferramentas CLI suportadas

Showdar Router funciona perfeitamente com todas as principais ferramentas de codificação de IA:
...
Configure `X-Showdar Router-Token-Saver: off` para ignorar todos os economizadores de tokens para uma solicitação de chat.
...
O headroom é opcional e funciona separadamente. Showdar Router chama o endpoint `/v1/compress` local do Headroom e, em seguida, mantém roteamento normal, fallback, autenticação e rastreamento de uso:

```
Cliente → Showdar Router → Headroom /v1/compress → Showdar Router → provedor
```
...
Se o Headroom estiver inativo ou retornar um erro, o o Showdar Router seguirá em modo aberto e enviará a solicitação original.
...
- Sua ferramenta CLI envia formato OpenAI → Showdar Router traduz → Provedor recebe formato nativo
...
> O próprio Showdar Router **nunca cobra** nada. Você paga apenas aos provedores diretamente (se usar serviços pagos).
>
...
> roteamento através do Showdar Router!
...
### 📊 Compreendendo os custos e faturamento do Showdar Router

**Como funciona o faturamento do Showdar Router:**

✅ **Software Showdar Router = GRATUITO para sempre** (código aberto, nunca cobra)  
...
❌ **Showdar Router nunca envia faturas** ou cobra seu cartão
...
- **Provedores baratos** (GLM, MiniMax): pague diretamente, Showdar Router apenas roteia
- **Provedores GRATUITOS** (iFlow, Kiro, Qwen): Genuinamente grátis para sempre, sem taxas ocultas
- **Showdar Router**: Nunca cobra nada
...
O painel rastreia o uso do token e exibe **custos estimados** como se você estivesse usando APIs pagas diretamente. Este **não é faturamento real** - é uma referência para mostrar quanto você está economizando usando modelos gratuitos ou assinaturas existentes através do Showdar Router.
...
<details>
<summary><b>💳 Serei cobrado pelo Showdar Router?</b></summary>

**Não.** Showdar Router é um software gratuito e de código aberto que roda em seu próprio computador. Nunca cobra nada.

**Você só paga:**

- ✅ **Provedores de assinatura** (Claude Code $20/mo, Codex $20-200/mo) → Pague-os diretamente em seus sites
- ✅ **Provedores baratos** (GLM, MiniMax) → Pague diretamente, Showdar Router apenas encaminha suas solicitações
- ❌ **Showdar Router em si** → **Nunca carrega nada, nunca**

Showdar Router é um proxy/roteador local. Não possui cartão de crédito, não pode enviar faturas e não possui sistema de cobrança. É um software totalmente gratuito.
...
O Showdar Router apenas encaminha suas solicitações para eles - não há pegadinhas ou cobrança futura do próprio Showdar Router. Eles são serviços verdadeiramente gratuitos e o Showdar Router os torna fáceis de usar com suporte alternativo.
...
- Showdar Router ajuda a maximizar seu valor por meio do rastreamento de cotas
...
O fallback inteligente do Showdar Router evita cobranças surpresa:
...
**Você está no controle:** Defina limites de gastos por provedor no painel e o Showdar Router os respeita.
...
**Dica profissional:** Use o Opus para tarefas complexas e o Sonnet para velocidade. Showdar Router rastreia cota por modelo!
...
Configurações → Modelos → Avançado:
  ...
  OpenAI API Key: [copie do painel do Showdar Router]
...
> **Nota:** OpenClaw só funciona com Showdar Router local. Use `127.0.0.1` em vez de `localhost` para evitar problemas de resolução IPv6.
...
**Persistência de dados:** `$HOME/.showdar-router/db/data.sqlite` no host ↔ `/app/data/db/data.sqlite` no contêiner.

### Variáveis de Ambiente

| Variável | Padrão | Descrição |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET` | Gerado automaticamente (`~/.showdar-router/jwt-secret`) | Segredo de assinatura JWT para cookie de autenticação do painel (substituir para compartilhar entre instâncias) |
| `INITIAL_PASSWORD` | `123456` | Primeira senha de login quando não existe hash salvo |
| `DATA_DIR` | `~/.showdar-router` | Localização principal dos dados do aplicativo (SQLite em `$DATA_DIR/db/data.sqlite`) |
| `PORT` | padrão da estrutura | Porta de serviço (`21298` nos exemplos) |
...
| `BASE_URL` | `http://localhost:21298` | URL base interna do lado do servidor usada por trabalhos de sincronização na nuvem |
...
- `${DATA_DIR}` e `~/.showdar-router` resolvem para o mesmo local em um contêiner Docker — o link simbólico `/root/.showdar-router -> /app/data` é criado no momento da construção.
...
- Atualizado automaticamente pelo Showdar Router
...
- Definir `PORT=21298` e `NEXT_PUBLIC_BASE_URL=http://localhost:21298`
...
- **Site**: [showdar-router.com](https://9router.com)
...
Obrigado a todos os colaboradores que ajudaram a tornar o Showdar Router melhor!
...
**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Um fork TypeScript completo do Showdar Router. Adiciona mais de 36 provedores, fallback automático de 4 camadas, APIs multimodais (imagens, incorporações, áudio, TTS), disjuntor, cache semântico, avaliações LLM e um painel sofisticado. Mais de 368 testes de unidade. Disponível via npm e Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Economizador de tokens em Rust. O Showdar Router porta seu pipeline de compactação para JS → **−20-40% de tokens de entrada** em cada solicitação.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"por que usar muitos tokens quando poucos tokens resolvem"_. Showdar Router adapta seu prompt → **−65% tokens de saída**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Estrelas](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — _"desenvolvedor sênior preguiçoso"_ habilidade. Showdar Router injeta sua abordagem YAGNI-first → **menos tokens, menos código, diferenças mais curtas**.

Um grande agradecimento a esses autores – sem o trabalho deles, os recursos de economia de tokens do Showdar Router não existiriam. Dê uma ⭐ a eles no GitHub!
