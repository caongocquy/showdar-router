 ...
 * into Showdar Router-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are Showdar Router fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic Showdar Router variant set for a single upstream Kiro model.
 *
 ...
 * into Showdar Router variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
