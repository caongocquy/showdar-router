 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what Showdar Router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a Showdar Router
 ...
 * The suffix is a Showdar Router request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a Showdar Router synthetic agentic variant.
...
/**
 * Detect whether a model id is a Showdar Router synthetic thinking variant
...
/**
 * Resolve a Showdar Router model id to the real upstream Kiro model id, plus flags
