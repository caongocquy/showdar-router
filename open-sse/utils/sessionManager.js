 ...
 * Since Showdar Router is long-running, we simulate this "per-launch" behavior by
 * storing a generated ID in memory for each connection.
 *
 * - If Showdar Router restarts, the ID changes (matching binary restart behavior).
