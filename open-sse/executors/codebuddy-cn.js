 ...
 * client sent it, so we force it true here — Showdar Router still re-aggregates the
...
export class CodeBuddyExecutor extends DefaultExecutor {
  ...
  transformRequest(model, body, stream, credentials) {
    ...
    // OpenAI-style params: reasoning_effort + reasoning_summary:"auto". Showdar Router's
