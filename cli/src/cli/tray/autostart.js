...
const APP_LABEL = "com.showdar-router.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when showdar-router is currently
 ...
 * SIGTERM to the running process. When the running showdar-router cli.js was itself
...
<dict>
    ...
    <string>/tmp/showdar-router.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/showdar-router.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `showdar-router.cmd` lookup that depended on the npm prefix path.
...
Type=Application
Name=Showdar Router
Comment=Showdar Router AI Gateway
