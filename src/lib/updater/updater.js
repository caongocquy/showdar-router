...
const packageName = process.env.SHOWDAR_ROUTER_PACKAGE || process.env.UPDATER_PKG_NAME || "showdar-router";
const port = parseInt(process.env.UPDATER_PORT || "21298", 10);
...
const appPort = parseInt(process.env.UPDATER_APP_PORT || "21298", 10);
