...
// Check if a system-level tailscaled is running (uses system socket, not Showdar Router's custom one).
 ...
 * State always lives in ~/.showdar-router/tailscale/ via --statedir.
 */
