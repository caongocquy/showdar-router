        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install Showdar Router, configure your providers via web dashboard, and start routing AI requests.
            </p>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Point your CLI tools to http://localhost:21298</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#3a2f27] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#f97815]">&gt;</span> Starting Showdar Router...<br/>
                  <span className="text-[#f97815]">&gt;</span> Server running on <span className="text-blue-400">http://localhost:21298</span><br/>
                  <span className="text-[#f97815]">&gt;</span> Dashboard: <span className="text-blue-400">http://localhost:21298/dashboard</span><br/>
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  <span className="text-gray-500">  macOS/Linux:</span> ~/.showdar-router/db/data.sqlite<br/>
                  <span className="text-gray-500">  Windows:</span> %APPDATA%/showdar-router/db/data.sqlite
                </div>
              </div>
            </div>
          </div>
