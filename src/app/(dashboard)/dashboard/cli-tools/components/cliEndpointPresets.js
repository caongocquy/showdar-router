...
const endpoints = createStore({
  storageKey: "showdar-router.cliToolEndpointPresets",
  changeEvent: "showdar-router:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "showdar-router.cliToolApiKeyPresets",
  changeEvent: "showdar-router:api-key-presets-changed",
  itemField: "key",
});
