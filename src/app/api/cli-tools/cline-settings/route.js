...
const hasShowdarRouterConfig = (globalState) => {
  ...
  return isOpenAi && (baseUrl.includes("localhost") || baseUrl.includes("127.0.0.1") || baseUrl.includes("showdar-router"));
};
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({ success: true, message: "Showdar Router settings removed from Cline" });
  } catch (error) {
