...
const PROVIDER_NAME = "showdar-router";
...
// Build TOML config for Showdar Router (openai provider mode)
const buildShowdarRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect Showdar Router by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildShowdarRouterConfig(baseUrl, apiKey || "sk_showdar", model);
