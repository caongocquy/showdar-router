...
// POST - Apply Showdar Router as openai-compatible provider (multi-model support)
...
// DELETE - Remove Showdar Router provider or specific models from config
export async function DELETE(request) {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: modelToRemove ? `Model "${modelToRemove}" removed` : "Showdar Router settings removed from OpenCode",
    });
  } catch (error) {
