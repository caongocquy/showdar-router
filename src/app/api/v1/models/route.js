...
// and break recursive loops between showdar-router instances connected to each other.
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // showdar-router instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another showdar-router fetching our /models)
