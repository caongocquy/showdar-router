 ...
 * If showdar-router's Anthropic→OpenAI conversion passes the input as a pre-parsed object,
 ...
 *   3. Forward to showdar-router /v1/chat/completions (OpenAI SSE)
