...
Showdar Router 兼容任何支持 OpenAI API 格式的工具。本指南介绍各种工具和自定义应用的通用集成模式。

## 概览

Showdar Router 提供 OpenAI 兼容的 API endpoint,可与以下场景配合使用:
- 自定义脚本与应用
- API 客户端与测试工具
- CLI 工具与实用程序
- 第三方集成
...
任何 OpenAI 兼容的工具都可以通过以下设置连接到 Showdar Router:
...
**方案:**
- 使用精确的模型名(大小写敏感)
- 查看可用模型:`curl http://localhost:21298/v1/models`
- 确认套餐中已启用该模型
