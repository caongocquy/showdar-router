...
将 Showdar Router 与 OpenAI Codex CLI 集成,通过 Showdar Router 的智能路由系统转发你的 OpenAI API 请求。
...
1. 在 Showdar Router 仪表盘中确认 API key 正确
...
2. 检查 Showdar Router 仪表盘中 OpenAI 提供商连接是否激活
3. 确认连接的提供商中包含该模型
