...
Integrate Showdar Router with Cline VSCode extension to route your AI requests through Showdar Router's intelligent routing system.
...
Set the base URL to your Showdar Router endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your Showdar Router endpoint
...
3. The key should start with `sk-showdar-router-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your Showdar Router configuration
...
4. Cline will use Showdar Router to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using Showdar Router
...
3. Get AI-powered explanations through Showdar Router

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use Showdar Router to understand context and make changes
...
2. Verify your Showdar Router instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check Showdar Router logs for any errors
...
1. In Cline settings, set Base URL to: `https://showdar-router.com`
2. Make sure you have configured your API key in the Showdar Router cloud dashboard
...
## Integration with Showdar Router Features

### Model Routing

Showdar Router automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, Showdar Router automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through Showdar Router dashboard:
- Total requests
- Token usage
- Cost per model
