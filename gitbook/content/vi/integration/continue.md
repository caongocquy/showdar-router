...
Tích hợp Showdar Router với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.
...
### 2. Thêm Cấu hình Model Showdar Router
...
3. Chọn model Showdar Router ưa thích
...
- Kiểm tra Showdar Router đang chạy: `curl http://localhost:21298/health`
...
- Chọn đúng model Showdar Router
...
- Kiểm tra độ trễ network đến Showdar Router
