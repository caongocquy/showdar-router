...
Tích hợp Showdar Router với Claude Code CLI để định tuyến request API Anthropic qua hệ thống routing thông minh của Showdar Router.
...
Claude Code hỗ trợ các alias model sau ánh xạ sang model Showdar Router:
