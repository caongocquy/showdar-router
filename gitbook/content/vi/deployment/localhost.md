...
Chạy Showdar Router trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt Showdar Router toàn cục qua npm:
...
Khởi động Showdar Router với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy Showdar Router.
