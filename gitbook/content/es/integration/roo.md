...
Integra Showdar Router con Roo AI Assistant para acceder a múltiples modelos de IA a través de una interfaz unificada.
...
Elige entre los modelos disponibles de Showdar Router:
...
```
Hello! Can you confirm you're connected through Showdar Router?
```
...
### Connection Failed
- Verifica que Showdar Router esté corriendo: `curl http://localhost:21298/health`
...
- Verifica que el modelo esté habilitado en tu plan de Showdar Router
- Intenta otro modelo de la lista

### Respuestas lentas
- Cambia a modelos más rápidos (haiku, flash)
- Verifica la conexión de red
- Monitorea los logs de Showdar Router por problemas
