...
Showdar RouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをShowdar Routerのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはShowdar Routerモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がShowdar Routerの設定と一致しているか確認
